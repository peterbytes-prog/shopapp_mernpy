...
from health_check import main as checkHealth
import pymongo
...
def main():
    #system check create report & send system check report
    health_errors = checkHealth()
    logger.warning(f'Health log: {health_errors}')
    ...
    logger.info('Completed Inventory Update')
    return True
